...
public:
  ...
  DecisionTree(bool verbose):
    verbose_(verbose), depth_(0),
    suspectLeaves_(0), partitionFactor_(0) {}
  ~DecisionTree()
  {
  ...
  // Comments by Yang: Use carefully, because it is not multithreading safe.
...
//                          << ", "
  ...
  void Read(std::istream& is)
  {
    ...
    readBasicType(is, partitionFactor_);
  ...
  void Write(std::ostream& os)
  {
    ...
    writeBasicType(os, partitionFactor_);
    for (index_t i = 0; i < nodeNum; ++i)
      {
